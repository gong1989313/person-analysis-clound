...
lazy val personAnalysisSpark = (project in file("personAnalysisSpark"))
	.settings(
		commonSettings,
		name := "personAnalysisSpark",
		version :="0.0.1",
		assemblyJarName in assembly := "personAnalysisSpark.jar",
		test in assembly :={},
